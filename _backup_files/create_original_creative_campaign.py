...
def create_ad_group(client, camp_resource: str, name: str, audience_resource: str,
    ...
    ag.final_url_suffix = f"utm_source=google&utm_medium=video&utm_campaign=belgium_original_dg&{utm_content}&gad_campaignid={{campaignid}}&gad_adgroupid={{adgroupid}}&gad_creative={{creative}}"
